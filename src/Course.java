...
public class Course {
	...
	public Course(final String CRN, final String Subject, final String Number, final BufferedReader br) throws Exception{
	...
	public void getProfessorRating() {
		rating = RateMyProfessor.getProfessorRating(Professor);
	}
	
	public Vector getrowData() {
		final Object[] data = {CRN, Subject, CourseNumber, Section, Credits, Title, Days, Time, Capacity, SpotsFilled, SpotsRemaining, Professor, ClassLocation};
